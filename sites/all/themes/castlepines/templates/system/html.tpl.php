...
<!--[if gte IE <?php print $minie; ?>]><!--> <html class="no-js" <?php print $html_attributes; ?> <?php print $rdf_attributes; ?>> <!--<![endif]-->
  <head>
    ...
    <script type="text/javascript" src="//use.typekit.net/noo2poo.js"></script>
    ...
    <!--[if lt IE 9]><script src="<?php print $GLOBALS['base_url'] . '/' . drupal_get_path('theme', 'castlepines'); ?>/js/html5shiv.min.js"></script><![endif]-->
